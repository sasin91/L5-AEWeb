...
class Account extends Model
{
    ...
    // In a case where a server already has accounts and then a web User is created with a different email, it wouldn't really be easy to link.
    // Maybe a like pivot on web db could be worthwhile?
